...
<div class="jumbotron" >
		...
		<form ng-controller="FormController as vmForm" class="form-horizontal templatemo-create-account templatemo-container"  role="form" action="#" method="post" enctype="multipart/form-data">
		...
		<div  ng-switch="vmForm.step"  class="form-inner">
				...
				<h3>Credentials</h3>
						<div class="form-group">
					            ...
					            <input type="text" class="form-control" name="" id="s1" placeholder=""  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  
					        ...
					        <div class="form-group">
					            ...
					            <input type="text" class="form-control" name="sem5" id="s1" placeholder=""  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  
					        </div>   	 
			      	...
			      	<h3>Personal Detail</h3>
					    ...
					    <div class="form-group">
					        <div class="col-md-3">		          	
					            ...
					            <input type="date" class="form-control" placeholder=""  id="dob" name="date_of_birth" value="<?php if(!empty($date_of_birth)){echo $date_of_birth;}  ?>" >		            		            		            
					        </div>  
					    	...
					    	<div class="col-md-6">
					          <label for="password" class="control-label">Upload Photo</label>
								<label class="btn btn-default btn-file">
		   						 Browse <input type="file"  name="photo" id="photo" required>
								</label>
							</div>
					    </div>
			        	...
			        	<h3>Contact Detail</h3>
					      <div class="form-group">
					          ...
					          <div class="col-md-6">		          	
					            ...
					            <input type="number" maxlength="10" class="form-control" name="contact_number_optional" id="con_op" value="<?php if(!empty($contact_number_optional)){echo $contact_number_optional;}  ?>" >		            		            		            
					          </div>               
					        </div>	
			          	...
			          	<h3>Edjucation Detail</h3>
					        <div class="form-group">
					          <div class="col-md-3">
					            ...
					            <input type="text" class="form-control" id="cpi"  name="cpi" value="<?php if(!empty($cpi)){ echo $cpi;}  ?>" >
					          </div>
					          <div class="col-md-3">
					            <label for="password" class="control-label">HSC</label>
					            <input type="text" class="form-control" id="cgpa"  name="cgpa" value="<?php if(!empty($cgpa)){echo $cgpa;}  ?>" >
					          </div>
					          <div class="col-md-3">
					            <label for="password" class="control-label">Gujcet Percentage</label>
					            <input type="text" class="form-control" id="tb"  name="total_block" value="<?php  if(!empty($total_block)){echo $total_block;}  ?>" > 
					          </div>
					          <div class="col-md-3">
					            <label for="password" class="control-label">Gujcate Merid Rank</label>
					            <input type="text" class="form-control" id="cb"  name="current_block" value="<?php if(!empty($current_block)){echo $current_block;}  ?>" >
					          </div>
					        </div>
					        ...
					        <div class="form-group">
					          ...
					          <div class="col-md-3 templatemo-radio-group" >
					          	...
					          	<div class="gen">
					          	<label class="radio-inline" >
				          			<input type="radio" name="gender" id="gen1"  value="Male" > Yes
				          		</label>
				          		<label class="radio-inline" >
				          			<input type="radio" name="gender" id="gen2"   value="Female" > No
				          		</label>
				          		</div>
					          </div>
					        ...
					        <div class="form-group">
					          ...
					          <div class="col-md-3">		          	
					            <label  class="control-label">&nbsp </label>
					            <input type="text" class="form-control" name="sem3" id="s3" placeholder="sem-4" value="<?php  if(!empty($sem3)){echo $sem3;}  ?>" >		            		            		            
					          </div>  
					        ...
					        <div class="form-group">
					         	<div class="col-md-3">		          	
					            <label  class="control-label">&nbsp </label>
					            <input type="text" class="form-control" name="sem5" id="s1" placeholder="sem-1"  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  

					          <div class="col-md-3">		          	
					            <label  class="control-label">&nbsp </label>
					            <input type="text" class="form-control" name="sem6" id="s2" placeholder="Sem-2"  value="<?php if(!empty($sem2)){echo $sem2;}  ?>" >		            		            		            
					          </div>  
					          <div class="col-md-3">		          	
					            <label  class="control-label">&nbsp </label>
					            <input type="text" class="form-control" name="sem7" id="s3" placeholder="sem-3" value="<?php  if(!empty($sem3)){echo $sem3;}  ?>" >		            		            		            
					          </div>
					          <div class="col-md-3">		          	
					            <label  class="control-label">&nbsp </label>
					            <input type="text" class="form-control" name="sem8" id="s3" placeholder="sem-4" value="<?php  if(!empty($sem3)){echo $sem3;}  ?>" >		            		            		            
					          </div>  
			          ...
			          <div class="stepfive" ng-switch-when="five">
			          	<h3>Bank Detail</h3>
					         ...
					         <div class="form-group">
					            ...
					            <input type="text" class="form-control" name="" id="s1" placeholder="street"  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  
					          	<div class="col-md-4">		          	
					            <label  class="control-label">&nbsp</label>
					            <input type="text" class="form-control" name="sem5" id="s1" placeholder="city"  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  
					          	<div class="col-md-4">		          	
					            <label  class="control-label">&nbsp</label>
					            <input type="text" class="form-control" name="sem5" id="s1" placeholder="State"  value="<?php if(!empty($sem1)){echo $sem1;}  ?>" >		            		            		            
					          	</div>  
					         </div>
					         <div class="form-group">
					         	<div class="col-md-6">		          	
